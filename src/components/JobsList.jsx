...
const JobsList = () => {
  ...
  const confirmarSubscripcion = async ()=>{
    setOpen(true)
                  ...
                  <div className="box pt-6">
                      <div className="box-wrapper">
                          ...
                          {/* stroke-linecap="round" stroke-linejoin="round" */}
                            <button onClick={()=>submit()} className="mx-3 flex-shrink-0 px-4 py-2 text-base font-semibold text-white bg-purple-600 rounded-lg shadow-md hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 focus:ring-offset-purple-200">
                              <svg className="text-white w-5 text-gray-600 h-5 cursor-pointer" fill="none" strokeWidth="2" stroke="currentColor" viewBox="0 0 24 24"><path d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path></svg>
                              </button>
                            <input 
                            onChange={(e)=> handle(e)} value={jobSearch} type="search" name="jobSearch" id="jobSearch" placeholder="search for images" x-model="q" 
                            ...
                            {/* <div className="select">
                              ...
                              <button onClick={()=>confirmarSubscripcion({user})} disabled={(hasJobs==false)?'disabled':''}
